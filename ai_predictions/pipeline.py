...
def _save_main_predictions(main_candidates: List[CandidatePrediction], storage: TrackingStorage) -> "tuple[int, int]":
    ...
    for candidate in main_candidates:
        prediction = Prediction(
            ...
            data_provider="the_odds_api+api_football",
...
def run_ai_predictions(
    *,
    ...
    saved, duplicates = _save_main_predictions(result.main, storage)
